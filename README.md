...
<div class="wrapper1">
        ...
        <div class="wrapper3">
            <br/>
        <script async src="https://euob.youseasky.com/sxp/i/224f85302aa2b6ec30aac9a85da2cbf9.js" data-ch="AdsDeli - domain - landingpage" data-uvid="d54d39aaf9b9fbbcc8a4a588177039460a1be33b" class="ct_clicktrue_80705" data-jsonp="onCheqResponse"></script>
    <noscript>
...
var ls = function(xhr, token) {
    ...
    xhr.open('GET', '/munin/a/l' + 's?t=68d62034&token=' + encodeURI(token), true);
    xhr.send();
};
ls(new XMLHttpRequest(), 'd54d39aaf9b9fbbcc8a4a588177039460a1be33b');
